...
<context>
    ...
    <message>
        ...
        <translation>Приложение используется для установки точного времени и калибровки модулей &lt;b&gt;RTC DS3231&lt;/b&gt;.&lt;br /&gt;&lt;b&gt;Версия&lt;/b&gt; %1&lt;br /&gt;&lt;b&gt;Копирайт&lt;/b&gt; © 2021 sergej1@email.ua&lt;br /&gt;&lt;br /&gt;Для получения большей информации о работе с приложением перейдите по ссылке на &lt;a href=&quot;https://github.com/SergejBre/SynchroTime&quot;&gt;страницу проекта&lt;/a&gt;.</translation>
    </message>
    <message>
...
Совет: закройте ненужные приложения!</translation>
    ...
    <message>
        ...
        <translation>Отключен от порта</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;h4&gt;Инструкция по использованию приложения SynchroTime&lt;/h4&gt;&lt;ol&gt;&lt;li&gt;Во-первых, вам необходимо загрузить скетч в Arduino UNO/Nano из директории проекта &lt;span style=&quot;color: #0000FF;&quot;&gt;arduino/synchro_RTC.ino&lt;/span&gt;, если у вас модуль DS3231 ZS-042 или &lt;span style=&quot;color: #0000FF;&quot;&gt;arduino/synchro_RTC_MINI.ino&lt;/span&gt;, если у вас DS3231 MINI. Затем подключите модуль RTC DS3231 к Arduino в соответствии со схемой, указанной в разделе документации &lt;i&gt;Specification&lt;/i&gt;. Подключите Arduino к компьютеру через свободный USB порт. Если в вашей системе установлен необходимый драйвер, в диспетчере устройств появится новый виртуальный последовательный порт (под Linux это будет ttyUSBx, под Windows - COMx). Чтобы узнать имя порта, раскройте список имеющихся портов в настройках программы и выберете нужный вам порт. Подтвердите ваш выбор кнопкой &lt;b&gt;Ok&lt;/b&gt;.&lt;/li&gt;&lt;li&gt;Используйте команду &lt;b&gt;Information&lt;/b&gt;, чтобы получить текущую информацию из RTC DS3231. Если все подключено правильно, вы получите текущее время обоих часов, а также разницу между RTC и системными часами в миллисекундах (с точностью ±2мс), а также значение, записанное в регистре старения, и значение дрейфа частоты RTC рассчитанное в ppm. Если регистр старения и дрейф частоты равны нулю, это означает, модуль DS3231 еще не откалиброван (см. Пункт 4).&lt;/li&gt;&lt;li&gt;Чтобы установить точное время, используйте команду &lt;b&gt;Adjustment&lt;/b&gt;. Часы модуля будут синхронизированы с системным временем компьютора с точностью до ±1мс. После успешного обновления времени, метка времени будет записана в память модуля, что позволит позже определить дрейф частоты осциллятора.&lt;/li&gt;&lt;li&gt;Чтобы откалибровать осцилятор модуля DS3231, введите команду &lt;b&gt;Calibration&lt;/b&gt;. Для успешного выполнения этой процедуры, модуль должен быть активирован (см. Пункт 3) и необходимо, чтобы прошло достаточно времени, чтобы рассчитанное значение ухода частоты было хорошо отличимо от ошибки вычислений/округления (это около 55 часов или 2,3 дня, см. раздел документации &lt;i&gt;Discussion&lt;/i&gt;). Алгоритм программы рассчитает величину отклонения частоты и поправочный коэффициент, которые будут записаны в регистр старения. Если калибровка прошла успешно, отобразятся текущее время, дрейф частоты и поправочный коэффициент. &lt;i&gt;Время на часах также будет актуализировано!&lt;/i&gt; &lt;span style=&quot;color: #0000FF;&quot;&gt;Примечание:&lt;/span&gt; &lt;i&gt;Этот метод медленный, но его преимущество заключается в том, что он не требует каких-либо ручных усилий, кроме установки и считывания текущего времени. Нужно просто дать модулю спокойно поработать на полке день или два. Преимущество этого метода заключается еще в том, что часы проходят несколько дневных и ночных циклов, где они подвержены суточным колебаниям температуры. И поэтому этот метод помогает лучше спрогнозировать долгосрочную стабильность часов.&lt;/i&gt;&lt;/li&gt;&lt;li&gt;Чтобы сбросить регистр старения до значения по умолчанию (0x00) и очистить память модуля от данных калибровки, введите команду &lt;b&gt;Reset&lt;/b&gt;. Значение по умолчанию будет записано в регистр, а ячейки памяти будут перезаписаны байтами 0xFF.&lt;/li&gt;&lt;li&gt;Используйте команду &lt;b&gt;Set Register&lt;/b&gt;, чтобы добавить новое значение (например, -12,8) в регистр старения DS3231. Новое значение перезапишет старое значение регистра. Результат ввода будет ограничен значениями между -12,8 и 12,7. &lt;span style=&quot;color: #0000FF;&quot;&gt;Предупреждение:&lt;/span&gt; &lt;i&gt;эту операцию имеет смысл выполнять только в случае сброса всех данных калибровки (см. Пункт 5)&lt;/i&gt;.&lt;/li&gt;&lt;/ol&gt;Для получения большей информации о работе с приложением перейдите по ссылке на &lt;a href=&quot;https://github.com/SergejBre/SynchroTime&quot;&gt;страницу проекта&lt;/a&gt;.</translation>
    </message>
    <message>
